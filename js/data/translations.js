export const TRANSLATIONS = {
  ko: {
    ...
    weight_tools_bmi_full: "Body Mass Index",
    weight_tools_bmi_formula: "체중(kg) ÷ 신장(m)²",
    weight_tools_bsa: "BSA",
    weight_tools_bsa_full: "Body Surface Area",
    weight_tools_bsa_formula: "Mosteller: √(Height × Weight ÷ 3600)",
    weight_tools_ibw: "IBW",
    weight_tools_ibw_full: "Ideal Body Weight",
    weight_tools_ibw_formula: "Devine: ♂ 50 + 0.9 × (Ht cm − 152.4) / ♀ 45.5 + 0.9 × (Ht cm − 152.4)",
    weight_tools_ffm: "FFM",
    weight_tools_ffm_full: "Fat-Free Mass",
    weight_tools_ffm_formula: "Janmahasatian: 9270 × TBW ÷ (6680 + 216 × BMI) [♂] 또는 (8780 + 244 × BMI) [♀]",
    weight_tools_lbm: "LBM",
    weight_tools_lbm_full: "Lean Body Mass",
    weight_tools_lbm_formula: "James: ♂ 1.1 × TBW − 128 × (TBW/Ht)² / ♀ 1.07 × TBW − 148 × (TBW/Ht)²",
    weight_tools_adjbw: "AdjBW",
    weight_tools_adjbw_full: "Adjusted Body Weight",
    weight_tools_adjbw_formula: "IBW + 0.4 × (TBW − IBW) — TBW와 IBW 차이의 40%를 보정",
    ...
    tab_last: "LAST",
    last_heading: "Local Anesthetic Toxicity Calculator",
    last_description: "체중 기반 국소마취제 최대 안전 용량을 확인하고, 투여 예정 용량의 안전 비율을 평가합니다.",
    last_note: "ASRA Practice Advisory (2020) 기반. 실제 최대 용량은 주사 부위, 혈관 분포, 환자 상태에 따라 달라질 수 있습니다.",
    last_view_note: "사용 참고사항",
    last_drug_select: "국소마취제",
    last_with_epinephrine: "Epinephrine 포함",
    last_planned_dose: "투여 예정 용량 (선택)",
    last_max_dose: "최대 안전 용량",
    last_max_dose_with_epi: "Epinephrine 포함 시 최대 용량",
    last_dose_basis: "{mgPerKg} mg/kg × {weight} kg",
    last_planned_ratio: "투여 예정 용량은 최대 용량의 {percent}%",
    last_planned_over: "투여 예정 용량이 최대 안전 용량을 초과합니다!",
    last_planned_within: "안전 범위 내",
    last_no_epi_benefit: "이 약물은 epinephrine 추가 시 최대 용량 증가 없음",
    last_onset: "Onset",
    last_duration: "Duration",
    last_drug_notes: "참고",
    last_quick_guide_title: "LAST 증상 & Intralipid 치료",
    last_signs_title: "LAST 증상/징후 (진행 순서)",
    last_signs_cns: "CNS: 이명, 구강 주위 저림, 금속 맛, 시각 장애, 어지러움, 불안/흥분 → 경련 → 의식 소실",
    last_signs_cvs: "심혈관: 고혈압/빈맥 → 저혈압/서맥 → 전도 장애 → 심실부정맥 → 심정지",
    last_intralipid_title: "Intralipid 20% 치료 프로토콜",
    last_intralipid_bolus: "Bolus: 1.5 mL/kg IV over 1 min (70 kg → 약 100 mL)",
    last_intralipid_infusion: "Infusion: 0.25 mL/kg/min for 30–60 min",
    last_intralipid_repeat: "Repeat bolus: 증상 지속 시 5분 간격으로 1–2회 반복 가능",
    last_intralipid_max: "최대 총 용량: 약 12 mL/kg",
    last_intralipid_avoid: "Propofol은 lipid rescue의 대체제가 아닙니다.",
    last_result_warning: "ASRA guideline 기반 참고 정보입니다. 기관 프로토콜과 환자 상태를 함께 확인하세요.",
    last_safety_label: "안전성 평가",
    placeholder_planned_dose: "예: 300",
    validation_last_weight: "체중을 입력하세요."
  },
  en: {
    ...
    weight_tools_bmi: "BMI",
    weight_tools_bmi_full: "Body Mass Index",
    weight_tools_bmi_formula: "Weight(kg) ÷ Height(m)²",
    weight_tools_bsa: "BSA",
    weight_tools_bsa_full: "Body Surface Area",
    weight_tools_bsa_formula: "Mosteller: √(Height × Weight ÷ 3600)",
    weight_tools_ibw: "IBW",
    ...
    weight_tools_ffm: "FFM",
    weight_tools_ffm_full: "Fat-Free Mass",
    weight_tools_ffm_formula: "Janmahasatian: 9270 × TBW ÷ (6680 + 216 × BMI) [♂] or (8780 + 244 × BMI) [♀]",
    weight_tools_lbm: "LBM",
    weight_tools_lbm_full: "Lean Body Mass",
    weight_tools_lbm_formula: "James: ♂ 1.1 × TBW − 128 × (TBW/Ht)² / ♀ 1.07 × TBW − 148 × (TBW/Ht)²",
    weight_tools_adjbw: "AdjBW",
    weight_tools_adjbw_full: "Adjusted Body Weight",
    weight_tools_adjbw_formula: "IBW + 0.4 × (TBW − IBW) — corrects 40% of the difference between TBW and IBW",
    ...
    tab_last: "LAST",
    last_heading: "Local Anesthetic Toxicity Calculator",
    last_description: "Check weight-based maximum safe doses for local anesthetics and evaluate planned dose safety ratio.",
    last_note: "Based on ASRA Practice Advisory (2020). Actual maximum doses may vary by injection site, vascularity, and patient condition.",
    last_view_note: "Usage note",
    last_drug_select: "Local Anesthetic",
    last_with_epinephrine: "With Epinephrine",
    last_planned_dose: "Planned Dose (optional)",
    last_max_dose: "Maximum Safe Dose",
    last_max_dose_with_epi: "Max Dose with Epinephrine",
    last_dose_basis: "{mgPerKg} mg/kg × {weight} kg",
    last_planned_ratio: "Planned dose is {percent}% of maximum",
    last_planned_over: "Planned dose exceeds maximum safe dose!",
    last_planned_within: "Within safe range",
    last_no_epi_benefit: "No max dose increase with epinephrine for this agent",
    last_onset: "Onset",
    last_duration: "Duration",
    last_drug_notes: "Note",
    last_quick_guide_title: "LAST Signs & Intralipid Treatment",
    last_signs_title: "LAST Signs/Symptoms (progression)",
    last_signs_cns: "CNS: tinnitus, perioral numbness, metallic taste, visual disturbance, dizziness, agitation → seizure → loss of consciousness",
    last_signs_cvs: "Cardiovascular: hypertension/tachycardia → hypotension/bradycardia → conduction abnormalities → ventricular arrhythmia → cardiac arrest",
    last_intralipid_title: "Intralipid 20% Treatment Protocol",
    last_intralipid_bolus: "Bolus: 1.5 mL/kg IV over 1 min (70 kg ≈ 100 mL)",
    last_intralipid_infusion: "Infusion: 0.25 mL/kg/min for 30–60 min",
    last_intralipid_repeat: "Repeat bolus: may repeat 1–2 times at 5-min intervals if symptoms persist",
    last_intralipid_max: "Maximum total dose: approximately 12 mL/kg",
    last_intralipid_avoid: "Propofol is NOT a substitute for lipid rescue.",
    last_result_warning: "Reference based on ASRA guidelines. Confirm with institutional protocol and patient condition.",
    last_safety_label: "Safety Assessment",
    placeholder_planned_dose: "e.g. 300",
    validation_last_weight: "Please enter patient weight."
  }
};
